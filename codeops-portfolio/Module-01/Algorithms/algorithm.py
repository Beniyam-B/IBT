...
# array_numbers = [1, 2, 3, 6, 4, 8]
# array_even =[]

# def getOnlyEvens(array_numbers):
#     for i in range(len(array_numbers)):
#         if array_numbers[i] % 2 == 0:
#             array_even.append(array_numbers[i])
#     return array_even

# array_of_evens = getOnlyEvens(array_numbers)
...
# def checkMeera(array_of_num):
#     for n in array_of_num:
#         if n * 2 in array_of_num:
